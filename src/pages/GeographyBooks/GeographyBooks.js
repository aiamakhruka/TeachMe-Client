...
import './GeographyBooks.scss'; // Ensure this file exists
    ...
    const fetchPlaylists = async () => {
      try {
        const response = await fetch(
          `https://www.googleapis.com/youtube/v3/search?part=snippet&type=playlist&q=geography&channelId=${channelId}&maxResults=50&key=${apiKey}`
        );
  ...
  return (
    <>
      ...
      <div className="hero-playlist">
        <h1 className="title">Geography Playlists</h1>
        {isLoading ? (
