...
// import './CSBooks.scss'; // Ensure this file exists
...
//   // List of desired keywords for computer science topics
...
//           `https://www.googleapis.com/youtube/v3/search?part=snippet&type=playlist&q=computer+science&channelId=${channelId}&maxResults=50&key=${apiKey}`
//         );
...
//         <h1 className="title">Computer Science Playlists</h1>
//         {isLoading ? (
