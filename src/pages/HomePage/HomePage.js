  ...
  return(
    <>
        ...
        <section className='subjects'>
            ...
            <img className="image" src={math}/>
            </div>
            <div className='subject-containers'>
            <p><strong>Chemistry</strong></p>
            <img className="image" src={chim}/>
            </div>
            <div className='subject-containers'>
            <p><strong>Physics</strong></p>
            <img className="image" src={phis}/>
            </div>
            <div className='subject-containers'>
            <p><strong>History</strong></p>
            <img className="image" src={history}/>
            </div>
            </div>
            <div className='row'>
            <div className='subject-containers'>
            <p><strong>Geograph</strong></p>
            <img className="image" src={geo}/>
            </div>
            <div className='subject-containers'>
            <p><strong>Language</strong></p>
            <img className="image" src={language}/>
            </div>
            <div className='subject-containers'>
            <p><strong>Computer Science</strong></p>
            <img className="image" src={cs}/>
            </div>
            <div className='subject-containers'>
            <p><strong>Engineering</strong></p>
            <img className="image" src={engin}/>
            </div>
            </div>
            </div>
        </section>
        <section className='list-of-teachers'>
            ...
            <div className='list-of-teachers__teacher-image'>
                <img className='list-of-teachers__single-teacher-image' src={teacher1}/>
                <h3>Michael Rodriguez</h3>
                <p>English Literature</p>
            </div>
            <div className='list-of-teachers__teacher-image'>
                <img className='list-of-teachers__single-teacher-image' src={teacher2}/>
                <h3>Olivia Thompson</h3>
                <p>History</p>
            </div>
            <div className='list-of-teachers__teacher-image'>
                <img className='list-of-teachers__single-teacher-image' src={teacher3}/>
                <h3>Emily Johnson</h3>
                <p>Mathematics</p>
            </div>
            </div>
        ...
        <section className='list-of-testimonials'>
            ...
            <img className='Icon-quote' src={IconQuote}/>
                ...
                <img className='list-of-testimonials__single-testimonial-image' src={student1}/>
            </div>
            <div className='list-of-testimonials__testimonial'>
            <img className='Icon-quote' src={IconQuote}/>
                ...
                <p className='testimonial-school'>High School Student</p>
                <img className='list-of-testimonials__single-testimonial-image' src={student2}/>
            </div>
            <div className='list-of-testimonials__testimonial'>
            <img className='Icon-quote' src={IconQuote}/>
                ...
                <img className='list-of-testimonials__single-testimonial-image' src={student3}/>
            </div>
            </div>
        </section>
        <section className='join'>
            <div className='join__left'>
                <img className='join__lamp' src={lamp}/>
            </div>
